...
export function AccessLayout() {
  return (
    <div className="min-h-dvh bg-brand-ivory font-sans text-brand-ink lg:grid lg:grid-cols-[42%_58%]">
      <aside className="relative overflow-hidden bg-brand-deep px-5 py-6 text-brand-ivory sm:px-8 lg:flex lg:min-h-dvh lg:flex-col lg:px-12 lg:py-10 xl:px-16">
        ...
        <div className="relative z-10 hidden flex-1 items-center lg:flex">
          <div className="max-w-md pb-10">
            ...
            <p className="mt-4 max-w-[10ch] font-heading text-heading-1 font-bold leading-tight">Un acceso cercano a la gestión de nuestra comunidad.</p>
            <p className="mt-5 max-w-sm leading-relaxed text-brand-ivory/80">Acceda a los servicios digitales de la Asociación desde un espacio claro, seguro y cercano.</p>
          </div>
        </div>
      ...
      <div className="flex min-h-[calc(100dvh-96px)] flex-col px-4 py-6 sm:px-6 sm:py-8 lg:min-h-dvh lg:px-8 xl:px-12">
        <div className="mx-auto flex w-full max-w-[38rem] flex-1 items-center py-2 lg:py-8">
          <div className="w-full rounded-2xl border border-border bg-surface p-5 shadow-lg sm:p-8 lg:p-9">
            <Outlet />
          </div>
        </div>
        <footer className="mx-auto mt-4 w-full max-w-[38rem] text-center">
